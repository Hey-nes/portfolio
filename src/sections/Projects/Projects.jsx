...
function Projects() {
	return (
		<section id="projects" className="projects section">
			...
			<img className="project-image" src={Motorcycle} alt="project-image" />
			...
			<p>
				...
				consectetur dolorum, commodi consequuntur est ullam sed a repellat iste
				vel nobis alias dicta earum omnis sint quae delectus atque! Lorem ipsum,
				dolor sit amet consectetur adipisicing elit. Atque modi quam iure quas
				optio, laudantium quibusdam voluptates nam rem, fugiat perspiciatis
				corrupti unde cum fuga repellat officia totam explicabo consectetur.
			</p>
			<IconHome />
		</section>
	);
